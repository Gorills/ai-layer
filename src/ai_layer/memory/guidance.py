...
DECISION_DOMAIN_HINTS = (
    "architecture", "provider", "api", "contract", "migration", "schema",
    "concurrency", "security", "auth", "database", "persistence", "integration",
    "архитект", "провайдер", "api", "контракт", "миграц", "схем",
    "конкурент", "безопас", "авторизац", "баз", "персист", "интеграц",
)
DECISION_ACTION_HINTS = (
    "choose", "select", "decide", "design", "redesign", "replace", "introduce",
    "tradeoff", "alternative", "approach", "new architecture",
    "выбер", "реши", "спроектир", "перепроектир", "замен", "введ",
    "вариант", "альтернатив", "подход", "новую архитект",
)
