...
def finish_work(
    ...
    *,
    ...
    if terminal == "completed" and not reported_summary:
        reported_summary = str(work.result_summary or "").strip() or f"Completed work: {work.goal}"
